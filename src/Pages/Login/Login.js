...
const Login = () => {
    ...
    return (
        <div className='form bg-light p-5 mt-5'>
            ...
            {errorElement}
            <p className='mt-3 text-center'>Create New Account?<br /> <Link to={'/register'} className='text-primary pe-auto text-decoration-none' onClick={navigateRegister}>Please Register</Link></p>
